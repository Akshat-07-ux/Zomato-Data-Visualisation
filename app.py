...
st.sidebar.write('AKSHAT BHAGAT')
st.sidebar.write('Btech CSE 3RD Year student')
...
user_menu = st.sidebar.radio(
    'Select an option',
    ('Countrywide Evaluation', 'State-wise Analysis', 'Restaurant-Wise Analysis', 'Food-wise Analysis', 'People Analysis',
     'Restaurants on Map')
)

if user_menu == 'Countrywide Evaluation':
    st.header('Countrywide Evaluation')
    st.sidebar.header('Countrywide Evaluation')
